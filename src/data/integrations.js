...
export const SERVICES = [
  ...
  { id: 'linkedin', name: 'LinkedIn', category: 'compte', color: '#070707', blurb: 'Synchronise ton parcours et ton réseau pro' },
  { id: 'apple', name: 'Apple Santé', category: 'montre', color: '#FF2D55', blurb: 'Apple Watch · cardio, activité & sommeil' },
  { id: 'garmin', name: 'Garmin Connect', category: 'montre', color: '#3A3731', blurb: 'Montres Garmin · GPS, allure, dénivelé' },
  { id: 'coros', name: 'COROS', category: 'montre', color: '#101010', blurb: 'Montres COROS · données d’entraînement' },
