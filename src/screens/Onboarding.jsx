...
const STEPS = [
  ...
  {
    icon: 'activity', tone: 'text-success-300',
    title: 'Cours, rencontre, avance',
    text: 'Rejoins des sorties, suis tes kilomètres et tes RDV. Chaque run devient une occasion business — et une ligne de plus à ton ROI réseau.',
  },
  {
    icon: 'crown', tone: 'text-gold-300', premium: true,
    title: 'Va plus loin avec Pro',
    text: 'Matchs illimités, « qui veut me rencontrer », agenda & RDV et intros prioritaires. Invite tes contacts et débloque 1 mois offert.',
  },
]
...
export default function Onboarding({ onClose, onEditProfile }) {
  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col overflow-hidden surface-hero text-white">
